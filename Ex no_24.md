...
3. Create a structure program to read(empno,dept and basic pay) and store the data of 3 employees and
4. calculate their Gross Salary(da =10% and HRA=30% from BP).5. Read the value using scanf.
...
![image](https://github.com/user-attachments/assets/a619bf57-e42f-4ba6-b18f-934eecedaf17)
